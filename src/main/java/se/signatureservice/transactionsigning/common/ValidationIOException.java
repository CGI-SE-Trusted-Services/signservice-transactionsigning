...
/**
 * Exception that indicates an intermittent error occurred while validating
 * a signature (eg. network timeout).
 *
...
public class ValidationIOException extends Exception {
     ...
     */
    public ValidationIOException(String message, Throwable cause){
        super(message,cause);
    }
}
